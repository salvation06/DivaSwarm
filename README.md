...
## 🚀 Simple Installation (v7.3.0)
To step onto the runway with Antigravity or Claude Code CLI:

1. **Download Release**: Grab the latest [v7.3.0 Release](https://github.com/salvation06/DivaSwarm/releases/tag/v7.3.0).
2. **Global Sync**:
...
- `eco:` → **Economy**. Grep-first, L1 agent usage to save tokens.
...
### Antigravity (User-Level)
```powershell
# Create directory
mkdir "$env:USERPROFILE\.antigravity\skills\DivaSwarm" -Force

# Copy skill from local source
Copy-Item -Recurse ".\.agent\skills\DivaSwarm\*" "$env:USERPROFILE\.antigravity\skills\DivaSwarm\"
```
...
---
*DivaSwarm v7.3.0: Precise technical orchestration with a touch of flair.*
